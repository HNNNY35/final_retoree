      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            ...
            <td class="">2023.02.04</td>
            <td>
              <div class="justify-content-center d-flex">
                <div>
                  <form action="/notice_contents">
                    <button
                      type="submit"
          ...
          <tr>
            ...
            <td>
              <div class="justify-content-center d-flex">
                <div>
                  <form action="/notice_contents_01">
                    <button
                      type="submit"
                      class="btn btn-sm btn-outline-primary">
                      수정
          ...
          <tr>
            ...
            <td>
              <div class="justify-content-center d-flex">
                <div>
                  <form action="/notice_contents_02">
                    <button
                      type="submit"
                      class="btn btn-sm btn-outline-primary">
                      수정
          ...
          <tr>
            ...
            <td>
              <div class="justify-content-center d-flex">
                <div>
                  <form action="/notice_contents_03">
                    <button
                      type="submit"
                      class="btn btn-sm btn-outline-primary">
                      수정
          ...
          <tr>
            ...
            <td>
              <div class="justify-content-center d-flex">
                <div>
                  <form action="/notice_contents_04">
                    <button
                      type="submit"
                      class="btn btn-sm btn-outline-primary">
                      수정
