  ...
  <body>
    ...
    <div class="event-contents container">
      ...
      <div class="event-view-tit">
        ...
        <h4 class="tit-area">내 차 사기 퀴즈 이벤트</h4>
        <span class="date-area">2023.02.02 ~ 2023.03.02</span>
      </div>
    </div>
    <div class="container img-area">
      <img
        src="https://cdn.autobell.co.kr/picture/event/43fb23150ee44f27a15b1e4efc089d1e"
        alt=""
      />
      <br /><br />
      <div class="list-btn">
