        ...
        <div class="side temp-box border" style="height: 350px;">
          <ul class="">
            ...
            <li id="">
                ...
                <ul class="sub">
                    <li id="">
                        <a href="" class="text-decoration-none text-primary">관심 차량</a>
                    </li>
                    <li id="">
                        <a href="" class="text-decoration-none text-primary">사고이력 조회</a>
                    </li>
                    <li id="">
                        <a href="" class="text-decoration-none text-primary">차량 등록/관리</a>
                    </li>
                </ul>
            </li>
        </ul>
        <ul class="">
            <li id="">
                ...
                <ul class="sub">
                    ...
                    <li id="">
                        <a href="./myPage_modify" class="text-decoration-none text-primary">회원정보수정</a>
                    </li>
                </ul>
            </li>
        </ul>
