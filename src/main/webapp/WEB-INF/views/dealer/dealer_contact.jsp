    ...
    <div class="container">
      ...
      <!-- 좌측 마이페이지 메뉴 -->
        ...
        <div class="col-9">
          ...
          <c:choose>
            <c:when test="${resultContact.STATUS_ID eq 'A001'}">
              <h4>답변하기</h4>
              <form action="/dealer_contact_submit" method="post">
                <input type="hidden" name="CONTACT_ID" value="${resultContact.CONTACT_ID}">
                <table class="table sales">
                  <tbody>
                    <tr>
                      <td>
                        <textarea name="ANS_CONTENT" id="ANS_CONTENT" cols="30" rows="10" class="form-control" placeholder="답변을 입력하세요." required></textarea>
                      </td>
                    </tr>
                    <tr>
                      <td class="text-center m-5">
                        <button type="submit" class="submitBtn">답변 등록</button>
                      </td>
                    </tr>
                  </tbody>
              </table>
