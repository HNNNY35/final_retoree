...
(
  CAR_IMG_ID     VARCHAR(100) NOT NULL COMMENT '차량 정보  UID',
  ATTACHFILE_SEQ VARCHAR(100) NOT NULL COMMENT '첨부파일 일련번호',
  IMG_INFO       VARCHAR(100) NULL     COMMENT '이미지 정보',
...
(
  ATTACHFILE_SEQ    VARCHAR(100) NOT NULL COMMENT '첨부파일 일련번호',
  SOURCE_UNIQUE_SEQ VARCHAR(100) NOT NULL COMMENT '원본레코드 UNIQUE SEQ',
  ATTACHFILE_TYPE   VARCHAR(100) NULL     COMMENT '첨부파일 유형',
